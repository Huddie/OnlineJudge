<?php
    ...
    $mars_user = 'adeh6562';
    $cmd = 'echo "'.$account_pass.'" | su -c "source /home/fa18/313/adeh6562/public_html/csac/OnlineJudge/sendgrid.env; python3 /home/fa18/313/adeh6562/public_html/csac/OnlineJudge/judge.py --filepath="'.$target_file.'" --email="'.$_POST["email"].'" 2> /home/fa18/313/adeh6562/public_html/csac/stderr.txt" - '.$mars_user;
